...
import com.felipe.palma.githubtrends_itriad.ui.fragment.favoritos.FavoritosListFragment;
...
public class HotRepoFragment extends Fragment {
    ...
    private void updateTimeSpan(final int position) {
        ...
        if (fragment instanceof HotRepoListFragment) {
            if (fragment.isAdded()) {
                ((HotRepoListFragment) fragment).updateTimeSpan(mTimeSpan);
            }
        }
    }
    ...
    public class LanguagesPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return HotRepoListFragment.newInstance(getContext(), languagesArray.get(position),mTimeSpan);
        }
